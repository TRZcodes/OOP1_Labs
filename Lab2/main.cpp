...
int main() 
{
    ...
    std::cout <<"Razem elementow: " << mtab1.sizeall() << std::endl;
    for (int i=0;i<mtab1.sizeall();i++) 
      std::cout << mtab1[i] << " ";
}
...
tab1 = [-1, 1, 3, 5, 19]
tab1 = 
moved tab1 = [-1, 1, 3, 5, 19]

Dołączanie listowe
next = [1, 1, 1]
next = [-1, 1, 3, 5, 19]
Mtab1: [-1, 1, 3, 5, 19] [1, 100, 1] [-1, 1, 3, 5, 19]
tab[6]= 100
Kopia mtab1: [-1, 1, 3, 5, 19] [1, 100, 1] [-1, 1, 3, 5, 19]

Dołączanie zwykle
Newtab: [0, 0, 0, -1, 1, 3, 5, 19]
Mtab1: [-1, 1, 3, 5, 19, 0, 0, 0] [1, 100, 1] [-1, 1, 3, 5, 19]
next = [1, 100, 1]
Razem elementow: 16
-1 1 3 5 19 0 0 0 1 100 1 -1 1 3 5 19 
*/
